...
| Workload | `json-comp`, `json-tls`, `in-out` *, `static-tls` | JSON serialization, gzip/brotli compression, HTTP/1.1 over TLS, a 100 KB body echoed over TLS so ingest and egress load together, 20-file static asset serving over TLS |
