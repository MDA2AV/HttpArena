...
| Workload | `json-comp`, `json-tls`, `upload` *, `static-tls` | JSON serialization, gzip/brotli compression, HTTP/1.1 over TLS, 20 MB body ingestion, 20-file static asset serving over TLS |
