...
public sealed class Dataset
{
    ...
    /// said it would take one. The span points at per-thread scratch and is written out before
    /// anything else can touch it.
    /// </summary>
    public ReadOnlySpan<byte> Render(int count, int multiplier, bool wantsBrotli, bool wantsGzip, out ReadOnlySpan<byte> encoding)
    {
        encoding = default;
