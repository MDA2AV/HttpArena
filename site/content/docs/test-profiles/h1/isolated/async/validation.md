...
Because the value is chosen after the container is up, nothing prepared at startup can answer it. The benchmark itself asks for a flat 20 ms, so this section carries all of the anti-cheat weight for the parameter.
