---
title: Validation
seo_title: "JSON Processing: /json Validation Checks"
description: "The correctness checks validate.sh runs against the /json endpoint - shared by the JSON TLS, JSON Compressed and JSON h2c profiles - before a framework's results are accepted."
---
