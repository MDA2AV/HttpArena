...
An entry that cannot hold the rate is not failed for it — it is flagged, because its number then describes a lighter workload than everyone else's. See [Validity](#validity-the-rate-has-to-have-been-delivered) below.
