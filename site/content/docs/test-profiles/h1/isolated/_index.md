...
{{< cards >}}
  ...
  {{< card link="millionaire" title="Millionaire" subtitle="One million req/s offered at a fixed rate; the metric is the CPU each framework spends to serve it, read exactly from its cgroup." icon="chip" >}}
