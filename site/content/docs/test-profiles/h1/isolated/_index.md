...
{{< cards >}}
  ...
  {{< card link="in-out" title="In-Out (100 KB echo)" subtitle="Posts 100 KB over TLS and requires it back verbatim - the only profile that loads ingest and egress at once." icon="cloud-upload" >}}
