...
{{< cards >}}
  ...
  {{< card link="efficiency" title="Efficiency (CPU at fixed load)" subtitle="Rate pinned at 500K req/s; the metric is the CPU each framework spends to serve it, read exactly from its cgroup." icon="chip" >}}
