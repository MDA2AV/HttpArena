...
{{< cards >}}
  {{< card link="isolated" title="Isolated" subtitle="Single-endpoint benchmarks - baseline, JSON, TLS echo, static files, concurrency, CPU cost and database access." icon="lightning-bolt" >}}
{{< /cards >}}
