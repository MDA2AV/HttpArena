...
- File serving strategy efficiency - how well the entry moves bytes off disk (sendfile, readahead, buffer sizing); caching the bodies is only open to Infrastructure entries
