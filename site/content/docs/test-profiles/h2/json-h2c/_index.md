...
The [`/json`](../../h1/json-tls/) workload transported over HTTP/2 cleartext on port 8082 - measures JSON serialization throughput under multiplexed h2c streams without TLS overhead.
