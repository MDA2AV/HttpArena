...
- The [HTTP/2 Static Files validation](../../h2/static-h2/validation) checks, which verify Content-Type headers, response sizes, 404 handling, and static freshness over HTTPS on port 8443
