...
{{< cards >}}
  ...
  {{< card link="completeness" title="Completeness" subtitle="Routing, middleware, request and response - each one a framework leaves to you takes 5% off its composite." icon="sparkles" >}}
